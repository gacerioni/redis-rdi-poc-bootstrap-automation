...
# Variables
FILES=(
    "https://redis-latam-rdi-poc-deps.s3.us-east-1.amazonaws.com/rdi-installation-1.6.0.tar.gz"
    "https://redis-latam-rdi-poc-deps.s3.us-east-1.amazonaws.com/redislabs-7.8.4-18-focal-amd64.tar"
)
DEST_DIR="/root"
