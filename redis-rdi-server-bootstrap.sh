...
# Variables
FILES=(
    "https://s3.amazonaws.com/redis-latam-rdi-poc-deps/rdi-installation-1.0.3.tar.gz"
    "https://s3.amazonaws.com/redis-latam-rdi-poc-deps/redislabs-7.4.2-169-focal-amd64.tar"
)
DEST_DIR="/root"
